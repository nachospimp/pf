...
class manager:
    ...
    def compute_portfolio(self, portfolio_type=None, target_return=None):
        ...
        # constraints and boundary positions
        ...
        # extend dataframe oh metrics with optimal weights and allocations 
...
class output:
    ...
    def plot_histogram (self):
        ...
        str_title += '\n' + 'return_annual=' + str(np.round(self.return_annual,decimals)) \
            ...
            + ' | ' + 'p_value=' + str(np.round(self.p_value,decimals)) \
...
def compute_efficent_frontier(rics, notional, target_return, include_min_variance):
    # special portfolios 
    label1 = 'min-variance-l1'
    label2 = 'min_variance-l2'
    label3 = 'equi-weight'
    label4 = 'long-only'
    ...
    returns = min_returns + np.linspace(0.05, 0.95, 200) * (max_returns-min_returns)
    ...
    #  create scatterplots of special portfolios: volatility vs return 
    ...
    plt.figure()
    plt.title('Efficent Frontier for a portfolio including ' + rics[0])
