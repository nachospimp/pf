# -*- coding: utf-8 -*-
"""
Created on Tue Feb 27 21:50:11 2024
...
class simulator():
    ...
    def generate_vector(self):
        ...
        if self. rv_type == 'normal':
            ...
            self.str_tittle = self.str_tittle + 'df=' + str(self.coeff)
            ...
            str_tittle = self.str_tittle + 'scale=' + str(self.coeff)
        elif self. rv_type == 'chi-squared':
            self.vector = np.random.chisquare(df=self.coeff, size=self.size)
            self.str_tittle = str_tittle + 'df=' + str(self.coeff)
